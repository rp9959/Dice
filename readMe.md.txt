...
For the given Java assignement, making sensible assumptions, total 3 REST end points are created.
...
This is for the assignment->Return the total number of simulations and total rolls made, grouped by all existing 
dice number–dice side combinations.

A sample call from Postman:
http://localhost:8080/totaldetails 

This returns the required details of all the existring combinations as a ResponseEntity<String>
...
Sum-on-Dice    Count-of-Sum    RelativeDistribution
12                 4               1.82%
17                 2               0.91%
29                 7               3.18%
34                 2               0.91%
...
One is SIMULATION and the other is DISTRIBUTION. and these two tables are linked by a "SimulationId".

c)SimulationService: It is the important class where entire functionalities are written. 
Three different functions are written here, each corresposning to a REST endpoint.
